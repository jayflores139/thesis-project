      ...
      <div class="w3-padding-large col-md-4">
        <div class="w3-padding w3-light-grey" style="height:auto;">
          ...
          <form class="w3-center" method="POst" id="form_history">
            <textarea id="history" class="w3-input w3-border"><?php echo $qq['content'] ?></textarea>
            <input type="hidden" id="ab_id_history" value="<?php echo $qq['ab_id'] ?>">
             <button type="submit" class="btn w3-blue w3-margin w3-round" id="edit_about_history">Edit</button>
           </form>
        </div>
      </div>
      ...
      <div class="w3-padding-large col-md-4">
        <div class="w3-padding w3-light-grey" style="height:auto;">
          ...
          <form class="w3-center" id="form_mission" method="POst" action="include/about.inc.php">
            <textarea id="mission" class="w3-input w3-border"><?php echo $qqq['content'] ?></textarea>
            <input type="hidden" id="ab_id_mission" value="<?php echo $qqq['ab_id'] ?>">
             <button type="submit" class="btn w3-blue w3-margin w3-round" id="edit_about_mission">Edit</button>
           </form>
        </div>
      </div>
      ...
      <div class="w3-padding-large col-md-4">
        <div class="w3-padding w3-light-grey" style="height:auto;">
          ...
          <form class="w3-center" method="POst" id="form_vision" action="include/about.inc.php">
            <textarea id="vision" class="w3-input w3-border"><?php echo $qqqq['content'] ?></textarea>
            <input type="hidden" id="ab_id_vision" value="<?php echo $qqqq['ab_id'] ?>">
             <button type="submit" class="btn w3-blue w3-margin w3-round" id="edit_about_vision">Edit</button>
           </form>
        </div>
      </div>
