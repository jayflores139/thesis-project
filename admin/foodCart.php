          ...
          <?php if (!empty($_SESSION['shopping_cart'])) {
            ...
            foreach ($_SESSION['shopping_cart'] as $key => $value) { ?>
              <tr>
                ...
                <td align="right">
                  <button type="submit" name="update_cart" class="w3-hover-grey w3-left w3-light-grey w3-border-0"
                  ...
                  <a href="foodCart.php?action=remove&id=<?php echo $value['id'] ?>" onclick="return confirm('Are you sure you want to delete this?')">
                     <button class="w3-hover-grey w3-light-grey w3-left w3-border-0" style="height:40px;width:40px"><i class="fas fa-trash-alt"></i></button></a></td>
              </tr>
          <?php
      ...
      <?php  } ?>
        <tr>
          <td colspan="6" align="center">
            <a class="w3-btn w3-green btn-continue w3-round" href="addFoodToCart.php">Continue Shopping</a>
          </td>
        </tr>
        </table>
      </div>
