...
<div class="container w3-light-grey w3-center containersssss">
  ...
  <div class="row" style="margin:10px;margin-top:50px">
    ...
    if (isset($_GET['p'])) {
        $RID = $_GET['p'];
        $f = mysqli_query($conn,"UPDATE reservation set r_status = 'cancel' where rid='$RID' ");
                    ...
                    if ($qq['r_status'] == 'pending') { ?>
                      ...
                      <td class="w3-padding-small w3-center" colspan="2">
                        <a href="?p=<?php echo $rid ?>">
                          <button class="w3-btn w3-light-grey w3-border w3-round-small w3-margin-top w3-ripple" onclick="return confirm('Are you sure?')">Cancel Reservation</button>
                        </a>
                      </td>
                    </tr>
                    <?php
