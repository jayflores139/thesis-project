...
if (isset($_POST['submitDELIVERY'])) {
	...
	if ($transaction_date < $today) {
		...
		$query = mysqli_query($conn,"INSERT INTO food_order (user_id, customer_type, curr_order_date, order_time, order_date, payment_mode, order_type, status) values ('$user_id', 'junior', '$today', '$transaction_time', '$transaction_date', '$MODEofPAYMENT', 'delivery', 'pending')") or die(mysqli_error($conn));
		if ($query == true) {
...
if (isset($_POST['submitDINEIN'])) {
	...
	if ($transaction_date < $today) {
		...
		$query = mysqli_query($conn,"INSERT INTO food_order (user_id, customer_type, curr_order_date, order_time, order_date, payment_mode, order_type, status) values ('$user_id', 'junior', '$today', '$transaction_time', '$transaction_date', '$MODEofPAYMENT', 'dinein', 'pending')");
		if ($query) {
...
if (isset($_POST['submitTAKEOUT'])) {
	...
	if ($transaction_date < $today) {
		...
		$query = mysqli_query($conn,"INSERT INTO food_order (user_id, customer_type, curr_order_date, order_time, order_date, payment_mode, order_type, status) values ('$user_id', 'junior', '$today', '$transaction_time', '$transaction_date', '$MODEofPAYMENT', 'takeout', 'pending')");
		if ($query) {
			$last_ids = mysqli_insert_id($conn);
			$dine_handler = true;
			$_SESSION['last_id_order'] = $last_ids;
...
if (isset($_POST['submitPICKUP'])) {
	...
	if ($transaction_date < $today) {
		...
		$query = mysqli_query($conn,"INSERT INTO food_order (user_id, customer_type, curr_order_date, order_time, order_date, payment_mode, order_type, status) values ('$user_id', 'junior', '$today', '$transaction_time', '$transaction_date', '$MODEofPAYMENT', 'pickup', 'pending')");
		if ($query) {
			$last_ids = mysqli_insert_id($conn);
			$dine_handler = true;
			$_SESSION['last_id_order'] = $last_ids;
