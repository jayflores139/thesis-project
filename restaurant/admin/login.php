    ...
    <div class="log-in-form">
      <div class="log-in-form-content">
        ...
        <div class="log-in-form-contents w3-text-white w3-center">
          ...
          <form action="login.inc.php" method="post" class="w3-white w3-padding-xlarge form" style="height:250px;">
            <label style="font-weight: normal;" class="w3-text-blue">Username</label>
            <input type="text" id="username" class="w3-input w3-border w3-border-blue-grey w3-margin-bottom" placeholder="Username" required>
            <label style="font-weight: normal;" class="w3-text-blue">Password</label>
            <input type="password" id="password" class="w3-input w3-border w3-border-blue-grey" placeholder="Password" required>
