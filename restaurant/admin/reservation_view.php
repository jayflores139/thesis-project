      ...
      if (isset($_GET['q'])) {  
        ...
        $o=0;
          ...
          if (isset($_POST['submit_payment'])) {
            ...
            if (isset($_POST['addOns'])) {
              if ($downpayment == $qq['payable']) {
                mysqli_query($conn,"UPDATE reservation set downpayment = '$downpayment', balance = '0',adOn_mis='paid', r_status='finish' where rid = '$rid' ");
                ...
                mysqli_query($conn,"UPDATE reservation set downpayment = '$downpayment', balance = '$balance', adOn_mis='paid', r_status='approve' where rid = '$rid' ");
                ...
                mysqli_query($conn,"UPDATE reservation set downpayment = '$downpayment', balance = '$bal', adOn_mis='paid', r_status='approve' where rid = '$rid' ");
                echo '<script>location="?rid='.$rid.'";alert("Reservation approve!")</script>';
              } 
            } else {
              if ($downpayment == $qq['payable']) {
          ...
          if (isset($_POST['submit_payment_full'])) {
            ...
            if (isset($_POST['addOns_full'])) {
              if ($downpayment_full >= $qq['balance']) {
                mysqli_query($conn,"UPDATE reservation set downpayment = '".$qq['payable']."', balance = '0', r_status='finish', adOn_mis='paid' where rid = '$rid' ");
                echo '<script>location="?rid='.$rid.'";alert("Reservation is fully paid!")</script>';
        ...
        <div class="">
            <div class="col-md-8" style="float: none;margin:0 auto">
                ...
                <?php  
                 ...
                 <tr>
                  <td class="w3-padding-small">
                    ...
                    <input type="number" step="any" disabled class="w3-input w3-border" value="<?php echo $qq['payable'] ?>"> <br>
                  </td>
                </tr>
                ...
                <tr>
                  <td class="w3-padding-small">
                    <label>Balance</label>
                    <input type="number" step="any" disabled class="w3-input w3-border" value="<?php echo $qq['balance'] ?>"> <br>
                  </td>
                </tr>
                <?php  
                  if (mysqli_num_rows($d) > 0) { ?>
                  <tr>
                    <td class="w3-padding-small">
                      <input type="checkbox" class="w3-check" name="addOns" value="<?php echo $qq['add_ons_ment'] ?>"> Add-ons payment is P <?php echo number_format($qq['add_ons_ment'],2).' <span class="w3-text-red">'.$qq['adOn_mis'] ?></span> <br><br>
                    </td>
                  </tr>
                   <?php
                  }
                ...
                <tr>
                  <td class="w3-padding-small">
                    ...
                    <input type="number" step="any" name="downpayment" required class="w3-input w3-border" value="<?php echo $qq['payable'] * $pp['d_price'] ?>"> <br>
                  </td>
                </tr>
                ...
                if (mysqli_num_rows($d) > 0) { ?>
                  <tr>
                  <td class="w3-padding-small">
                    <input type="checkbox" class="w3-check" <?php if ($qq['adOn_mis'] == 'unpaid') {
                      echo 'checked';
                      echo 'required';
                    } else {
                      echo 'disabled';
                    } ?> name="addOns_full" value="<?php echo $qq['add_ons_ment'] ?>"> Add-ons payment is P <?php echo number_format($qq['add_ons_ment'],2).' <span class="w3-text-blue">'. $qq['adOn_mis'] ?></span> <br><br>
                  </td>
                </tr>
                <?php
                }
                ...
                <tr>
                  <td class="w3-padding-small">
                    ...
                    <input type="number" step="any" name="downpayment_full" required class="w3-input w3-border" value="<?php echo $qq['balance'] ?>"> <br>
                  </td>
                </tr>
