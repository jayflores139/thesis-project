    ...
    <div class="right-fixed green">
      <div class="order_page" style="margin-top:5px;margin-bottom:15px;">
        ...
        <div class="w3-left w3-light-grey" style="width:100%">
          ...
          <a href="?q=e">
            <button class="w3-btn w3-left w3-blue ">Reserved</button>
          </a>
       ...
       <?php
        ...
        if (isset($_GET['t']) && $_GET['t'] == "t") { 
          ...
          <div class="tabs w3-border-top" style="padding:30px;margin-top:5px">
            ...
            <form action="?t=t&p=<?php echo $_GET['p'] ?>" method="POST">
              ...
              if (isset($_GET['v'])) { 
                ...
                <input type="text" disabled class="w3-input w3-border" step="any" id="amount" value="<?php echo number_format($amount,2) ?>">
              <?php  
              } else { ?>
              <input type="hidden" name="amount_junior" value="<?php echo number_format($_GET['p'],2) ?>">
                <input type="text" disabled class="w3-input w3-border" step="any" id="amount" name="amount" value="<?php echo number_format($_GET['p'],2) ?>">
              <?php
              }
              ?>
               <br>
              ...
              <label>Cash</label>
              <input type="number" class="w3-input w3-border" step="any" name="cash_money" id="cash_money" required> <br>

              <label>Change</label>

              <input type="text" class="w3-input w3-border" name="change" id="change"> <br>

              <button class="w3-btn w3-green" name="submit_payment">Submit</button>
              <button class="w3-btn w3-light-grey" type="button" onclick="history.back()">Cancel</button>
            </form>
