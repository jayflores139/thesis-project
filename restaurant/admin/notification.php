            ...
            <table class="w3-white w3-left w3-bordered w3 w3-table">
              <tr>
                ...
                while ($rrr = mysqli_fetch_array($dd)) { ?>
                  <tr>
                    <td><a href="order_view.php?id=<?php echo $rrr['order_id'] ?>"><?php echo date("F d, Y",strtotime($rrr['curr_order_date'])); ?></a></td>
                    <td><a href="order_view.php?id=<?php echo $rrr['order_id'] ?>"> You have new orders incoming this <?php echo date("M d, Y", strtotime($rrr['order_date'])) ?>.</a></td>
                  </tr>
                <?php
                }
              }
