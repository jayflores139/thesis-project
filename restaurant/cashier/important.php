        ...
        <div class="tabs" style="margin-top:-10px;">
          ...
          <div class="button-group">
            <form id="form_search">
              ...
              <input type="text" id="datesasaass" class="w3-left w3-border-blue w3-border w3-text-grey w3-round" placeholder="Booking Date">
               <input type="text" id="cu_name" class="w3-left w3-border-blue w3-border w3-text-grey w3-round" placeholder="Search name">
            ...
            <table class="w3-border w3-text-grey w3-center" style="font-size:14px" id="table__ble">
              ...
              while ($qq = mysqli_fetch_array($q)) { ?>
               ...
               <tr class="w3-border">
                ...
                <td class="w3-padding-medium"><?php echo date("M d, Y", strtotime($qq['r_date'])) ?></td>
                <td class="w3-padding-medium"><?php echo date("h:i A", strtotime($qq['r_time'])) ?></td>
                ...
                <td class="w3-padding-medium">
                 ...
                 <?php   
                  ...
                  <button id="'.$qq['rid'].'" class="delete w3-light-grey w3-left w3-border-0 w3-hover-grey" style="width:35px;height:35px;">
