...
<!--SALESSALESSALESSALESSALESSALESSALESSALESSALESSALESSALESSALESSALESSALESSALESSALESSALESSALESSALESSALESSALESSALESSALESSALESVVVSALESSALESALESSALESSALESSSALES-->
              ...
              <legend class="w3-padding-0" style="width:auto;margin:0;font-size:15px">
                <ul class="w3-navbar nav-top">
                  <li class="w3-padding-0"><a href="reports.php?i=sales" class=" w3-hover-light-grey">Sales</a></li>
                  <li class="w3-padding-0"><a href="reports.php?i=orders" class=" w3-hover-light-grey">Orders</a></li>
                  <li class="w3-padding-0"><a href="reports.php?i=reservations" class=" w3-hover-light-grey">Reservations</a></li>
                </ul>
              </legend>
              <div class="button-group w3-margin-bottom w3-margin-top" style="width:60%;margin:0 auto">
                  <input type="text" id="date_from" class="date_from w3-left w3-border-blue w3-border w3-text-grey w3-round" placeholder="From" style="margin-left:25px">
                  <input type="text" id="date_to" class="date_to w3-left w3-border-blue w3-border w3-text-grey w3-round" placeholder="To" style="margin-left:25px">
              ...
              <table class="w3-border w3-text-grey w3-centered" id="table__ble">
                ...
                <tr class="w3-border w3-text-grey">
                <?php
                ...
                <tr class="w3-text-black">
                  <td colspan="6" class="w3-padding w3-light-grey" style="text-align:right;font-size:19px">GRAND TOTAL: P <?php echo number_format($grand,2) ?></td>
                </tr>                
              </table>
            </fieldset> 
                <?php
...
<!--ORDERSORDERSORDERSORDERSORDERSORDERSORDERSORDERSORDERSORDERSORDERSORDERSORDERSORDERSORDERSORDERSORDERSORDERSORDERSORDERSORDERSORDERSORDERSORDERSORDERSORDERS-->
               <fieldset class="w3-margin-bottom">
                    ...
                    <div class="button-group w3-margin-bottom w3-margin-top" style="width:60%;margin:0 auto">
                        <input type="text" id="date_from" class="date_from_order w3-left w3-border-blue w3-border w3-text-grey w3-round" placeholder="From" style="margin-left:25px">
                        <input type="text" id="date_to" class="date_to_order w3-left w3-border-blue w3-border w3-text-grey w3-round" placeholder="To" style="margin-left:25px">
                        <button type="button" id="submit_filter_orers" class="w3-left w3-btn w3-border w3-blue w3-round w3-border-blue">Filter</button>
                    </div>
                    <table class="w3-bordered w3-text-grey w3-centered" id="table__ble2">
                      <tr class="w3-border w3-text-blue">
                    ...
                    $q = mysqli_query($conn, "SELECT * FROM food_menu");
                     while ($qq = mysqli_fetch_array($q)) { 
                        ...
                        <tr>
                          <td class="w3-border"><?php echo $qq['food_name'] ?></td>
                          <td class="w3-border">
                            <?php 
...
<!-- RESERVATIONRESERVATIONRESERVATIONRESERVATIONRESERVATIONRESERVATIONRESERVATIONRESERVATIONRESERVATIONRESERVATIONRESERVATIONRESERVATIONRESERVATIONRESERVATION-->
              <fieldset class="w3-margin-bottom">
                  ...
                  <table class="w3-border w3-text-grey w3-centered" id="table__bleff">
                    <tr class="w3-border w3-text-blue">
                      <td class="w3-padding-medium">Date</td>
                      <td>Occasion</td>
                      <td>Remarks</td>
