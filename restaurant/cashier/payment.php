        ...
        if (isset($_GET['id'])) {
          ...
          <table class="w3-border w3-border-grey centered">
              ...
              <?php
                ...
                <tr>
                  <td align="right" style="padding:30px 20px 0 20px" colspan="3">Sub-total: P <?php echo number_format($total,2) ?></td>
                </tr>
                <?php
                ...
                while ($qq = mysqli_fetch_array($q)) {
                  ...
                  <tr>
                    <td align="right" style="padding:0 20px" colspan="3">VAT: 12%</td>
                  </tr>
                <?php
                }
