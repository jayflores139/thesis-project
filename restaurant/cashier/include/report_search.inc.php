...
include '../../includes/connect.php';
    ...
    while ($qq = mysqli_fetch_array($q)) { 
    	echo '<tr class="w3-border w3-text-grey">';
    ...
    echo '
    	<tr class="w3-text-grey">
	      <td colspan="6" class="w3-padding w3-light-grey" style="text-align:right;font-size:19px">GRAND TOTAL: P '.number_format($grand,2).'</td>
	    </tr>	
    ';    
