            ...
            <?php
                if (isset($_GET['type']) && $_GET['type'] == "dinein") {
                  echo '
                    ...
                    <input type="text" id="datesasaass" autocomplete="off" class="w3-left w3-border-blue w3-border w3-text-grey w3-round" placeholder="Dine-in date" style="margin-left:25px">
                  ...
                  echo '
                    ...
                    <input type="text" id="datesasaass" autocomplete="off" class="w3-left w3-border-blue w3-border w3-text-grey w3-round" placeholder="Delivery date" style="margin-left:25px">
                  ...
                  echo '
                    ...
                    <input type="text" id="datesasaass" autocomplete="off" class="w3-left w3-border-blue w3-border w3-text-grey w3-round" placeholder="Pick up date" style="margin-left:25px">
                  ...
                  echo '
                    ...
                    <input type="text" id="datesasaass" autocomplete="off" class="w3-left w3-border-blue w3-border w3-text-grey w3-round" placeholder="Take out date" style="margin-left:25px">
                    <button type="submit" id="submit_take" class="w3-left w3-btn w3-border w3-blue w3-round w3-border-blue">Search</button>
                  ';
                }
            ?>
            <a href="addFoodToCart.php"><button class="w3-btn w3-round w3-text-blue w3-border w3-border-blue w3-hover-blue w3-transparent w3-right"><i class="fas fa-plus"></i> Add Order</button></a>
