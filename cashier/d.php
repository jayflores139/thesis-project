                  ...
                  while ($ee = mysqli_fetch_array($e)) { ?>
                   ...
                   <?php
                    ...
                    ?>
                      ...
                      <form class="form_search_de w3-left">
          ...
          <div id="tabs-1">
            <fieldset class="w3-margin-bottom">
              ...
              ?>
                ...
                <td class="w3-padding-small"><input type="text" disabled class="w3-input w3-border" value="<?php echo number_format($t,2) ?>"></td>
              </tr>
              <tr>
                <?php
                ...
                <td class="w3-padding-small"><input type="text" disabled class="w3-input w3-border" value="<?php echo date("M d, Y", strtotime($qq['order_date'])).' / '.date("h:i A", strtotime($qq['order_time'])) ?>"></td>
                  ...
                  <td class="w3-padding-small"><input type="text" disabled class="w3-input w3-border" value="<?php echo number_format($bb['discount'] * $qq['order_amount'],2) ?>"></td>
                   <?php    
                     } elseif ($qq['customer_type'] == "junior") { ?>
                  <td class="w3-padding-small">Discount: </td>
                  <td class="w3-padding-small"><input type="text" disabled class="w3-input w3-border" value="0.00"></td>
                    <?php
                     }
                ?>
              ...
              ?>
              <tr> 
                  <?php if ($qq['order_type'] == "delivery" || $qq['order_type'] == "dinein" || $qq['order_type'] == "takeout" || $qq['order_type'] == "pickup") { ?>
