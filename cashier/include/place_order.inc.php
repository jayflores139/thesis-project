...
if (isset($_POST['submitDELIVERYsenior'])) {
  ...
  if ($transaction_date < $today) {
    ...
    if (!empty($delivery_personName) || !empty($delivery_personContact)) {
        ...
        $query = mysqli_query($conn,"INSERT INTO food_order (user_id, curr_order_date, order_time, order_date, payment_mode, order_type, status,invoice_num) values ('0', '$today', '$transaction_time', '$transaction_date', '$MODEofPAYMENT', 'delivery', 'pending', '$invoice')") or die(mysqli_error($conn));
...
if (isset($_POST['submitDINEINjunior'])) {
  ...
  if ($transaction_date < $today) {
    $data['invalid'] = "Invalid dine-in date!";
        ...
        $query = mysqli_query($conn,"INSERT INTO food_order (user_id, curr_order_date, order_time, order_date, payment_mode, order_type, status, invoice_num) values ('0', '$today', '$transaction_time', '$transaction_date', '$MODEofPAYMENT', 'dinein', 'pending', '$invoice')") or die(mysqli_error($conn));
...
if (isset($_POST['submitPICKUPjunior'])) {
  ...
  if ($transaction_date < $today) {
    $data['invalid'] = "Invalid pick up date!";
        ...
        $query = mysqli_query($conn,"INSERT INTO food_order (user_id, curr_order_date, order_time, order_date, payment_mode, order_type, status, invoice_num) values ('0', '$today', '$transaction_time', '$transaction_date', '$MODEofPAYMENT', 'pickup', 'pending', '$invoice')") or die(mysqli_error($conn));
...
if (isset($_POST['submitTAKEOUTjunior'])) {
  ...
  if ($transaction_date < $today) {
    $data['invalid'] = "Invalid take out date!";
        ...
        $query = mysqli_query($conn,"INSERT INTO food_order (user_id, curr_order_date, order_time, order_date, payment_mode, order_type, status, invoice_num) values ('0', '$today', '$transaction_time', '$transaction_date', '$MODEofPAYMENT', 'takeout', 'pending', '$invoice')") or die(mysqli_error($conn));
...
if (isset($_POST['cash_money_senior'])) {
  $amount_senior = $_POST['amount_senior'];

  if (empty($_POST['cash_money_senior'])) {
    echo "";
  } else {
    echo number_format($_POST['cash_money_senior'] - $amount_senior, 2);
  }
}
